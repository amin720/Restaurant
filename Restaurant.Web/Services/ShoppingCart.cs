...
namespace Restaurant.Web.Services
{
	...
	{
		private readonly RestaurantEntities _context;
		private readonly string _cartId;

		public ShoppingCart(HttpContextBase context)
			: this(context, new RestaurantEntities())
		{
		}

		public ShoppingCart(HttpContextBase httpContext, RestaurantEntities context)
		{
			_context = context;
